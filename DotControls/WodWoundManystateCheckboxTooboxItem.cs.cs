...
namespace Syndaryl.Windows.Forms
{
    ...
    class WodWoundManystateCheckboxToolboxItem : ToolboxItem
    {
        // The add components dialog in VS looks for a public 
        // ctor that takes a type. 
        public WodWoundManystateCheckboxToolboxItem(Type toolType)
			: base(toolType)
		{
		}
        ...
        WodWoundManystateCheckboxToolboxItem(SerializationInfo info, StreamingContext context)
		{
            ...
            IDesignerHost host)
        {
            ...
            // component, which is an instance of WodWoundManystateCheckbox.
            //((WodWoundManystateCheckbox)comps[0]).SetupDotsTable();
